...
<div class="container my-4">
    <div class="card shadow-sm p-4">
        <div class="text-center mb-3">
            <h5 class="fw-bold">Detail Aktifitas Tebu Sendiri <span class="text-danger"><?= $activityLog->plot->code ?></span></h5>
        </div>
        <div class="border p-4" id="print-area">
            ...
            <div class="d-flex flex-column my-3">
                <div><strong>Petak Tanah (Plot):</strong> <?= $activityLog->plot->code ?></div>
                <div><strong>Lama Pengerjaan:</strong> <?= $activityLog->time_of_work ?> Hari (<?= $activityLog->start_date ?> - <?= $activityLog->end_date ?>)</div>
                <div><strong>Luasan :</strong> <?= $activityLog->plot->wide ?> Hectare</div>
            </div>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        <?php foreach ($data as $material) { ?>
                            <tr>
                                <td><?= $material['name'] ?></td>
                                <td><?= $material['unit'] ?> <?= $material['uom'] ?></td>
                                <td class="format-rupiah"><?= $material['total'] ?></td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
                    <tr>
                        <th colspan="2">Total</th>
                        <th class="format-rupiah"><?= $activityLog->total_cost ?></th>
                    </tr>
                </tbody>
            </table>
