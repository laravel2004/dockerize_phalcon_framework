        ...
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="img-fluid align-items-center">
                    <img src="{{ url.get('img/logo.png') }}" alt="logo" class="img-fluid ms-3" style="width: 200px; height:100px;">
                </div>
            </div>
        </div>
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    ...
                    {% endif %}
                >
                    <a href="{{ url.get('/frontend/dashboard') }}" class="sidebar-link">
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li
                    {% if routeName == "absensi-worker"  %}
                         class="sidebar-item active"
                    {% else %}
                        class="sidebar-item"
                    {% endif %}
                >
                    <a href="{{ url.get('/frontend/absensi') }}" class="sidebar-link">
                ...
                <li
                    ...
                    {% endif %}
                >
                    <a href="{{ url.get('/frontend/report') }}" class="sidebar-link">
                        <i class="bi bi-flag-fill"></i>
                        <span>Activity Input</span>
                    </a>
                </li>
                <li
                    {% if routeName == "report-history"  %}
                         class="sidebar-item active"
                    {% else %}
                        class="sidebar-item"
                    {% endif %}
                >
                    <a href="{{ url.get('/frontend/report/history') }}" class="sidebar-link">
                ...
                <li class="nav-item sidebar-item">
                        ...
                        <ul id="menuDropdown" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                            <li
                                ...
                                {% endif %}
                            >
                                <a href="{{ url.get('/frontend/uom-setting') }}" class="sidebar-link">
                                    <i class="bi bi-speedometer"></i>
                                    <span>UoM Setting</span>
                                </a>
                            </li>
                            <li
                                {% if routeName == "conversion-uom"  %}
                                     class="sidebar-item active"
                                {% else %}
                                    class="sidebar-item"
                                {% endif %}
                ...
                <li
                    ...
                    {% endif %}
                >
                    <a href="{{ url.get('/frontend/supporting-material') }}" class="sidebar-link">
                        <i class="bi bi-box"></i>
                        <span>Supporting Material</span>
                    </a>
                </li>
                <li
                    {% if routeName == "activity-log"  %}
                         class="sidebar-item active"
                    {% else %}
                        class="sidebar-item"
                    {% endif %}
                >
                    <a href="{{ url.get('/frontend/activity-log') }}" class="sidebar-link">
                        <i class="bi bi-journal-text"></i>
